...
<td align="center" width="900" bgcolor="white">
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      <h1 class="text-center mt-4">Tambah Sepatu</h1>
      <form method="POST">
        <div class="mb-3">
          <label for="inputKode" class="form-label">Kode</label>
          <input type="number" class="form-control" id="inputKode" name="kode" placeholder="Masukan Kode Sepatu">
        </div>
        <div class="mb-3">
          <label for="inputMerk" class="form-label">Merk</label>
          <input type="text" class="form-control" id="inputMerk" name="merk" placeholder="Masukan Merk Sepatu">
        </div>
        <div class="mb-3">
          <label for="inputHarga" class="form-label">Harga</label>
          <input type="text" class="form-control" id="inputHarga" name="harga" placeholder="Masukan Harga Sepatu">
        </div>
        <div class="mb-3">
          <label for="inputKategori" class="form-label">Kategori</label>
          <input type="text" class="form-control" id="inputKategori" name="kategori" placeholder="Masukan Kategori Sepatu">
        </div>
        <div class="mb-3">
          <label for="inputUkuran" class="form-label">Ukuran</label>
          <input type="number" class="form-control" id="inputUkuran" name="ukuran" placeholder="Masukan Ukuran Sepatu">
        </div>
        <div class="mb-3">
          <label for="inputWarna" class="form-label">Warna</label>
          <input type="text" class="form-control" id="inputWarna" name="warna" placeholder="Masukan Warna Sepatu">
        </div>
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "INSERT INTO tb_sepatu (kode, merk, harga, kategori, ukuran, warna) VALUES('".$kode."', '".$merk."', '".$harga."', '".$kategori."', '".$ukuran."', '".$warna."')";
