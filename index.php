...
<td align="center" width="900" bgcolor="white">
    ...
    <section class="row">
    <div class="col-md-9 offset-md-1 align-self-center"> 
      <h1 class="text-center">Input Sepatu</h1>
            ...
            foreach ($result as $data){
              echo "
                <tr>
                  ...
                  <td> 
                    <a href='update.php?kode=".$data["kode"]."' type='button' class='btn btn-success'>Update</a>
                    <a href='delete.php?kode=".$data["kode"]."' type='button' class='btn btn-danger' onlick='return confirm('Yakin ingin menghapus data?')'>Delete</a>
                  </td>
                </tr>  
              ";
            }
