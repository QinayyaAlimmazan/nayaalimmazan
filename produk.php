        ...
        <div class="col-sm-3">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p><a href="index1.php?halaman=keranjang-belanja&kode_produk=<?php echo $data['kode_produk'];?>&aksi=tambah_produk&jumlah=1" class="btn btn-primary btn-block" role="button">Masukan Keranjang</a></p>
                </div>
            </div>
        </div>
        <?php 
